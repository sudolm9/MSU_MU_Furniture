...
<p class="p-3 mb-2 bg-danger text-white" align = "center">List of Products</p>
  ...
  <div class="collapse navbar-collapse" id="navbarSupportedContent">
    <ul class="navbar-nav mr-auto">
      <li class="nav-item active">
        <a class="nav-link active text-danger" href="sofa.php">Sofa's</a>
      </li>
      <li class="nav-item">
        <a class="nav-link active text-danger" href="chair.php">Chair's</a>
        <li>
        <a class="nav-link active text-danger" href="table.php">Table's</a>
      </li>
      <li>
        <a class="nav-link active text-danger" href="drawer.php">Drawer's</a>
      <li>
        <a class="nav-link active text-danger " href="bed.php">Bed's</a>
      </li>
      <li>
          <a class="nav-link active text-danger" href="cart.php">Cart</a>
      </li>
      <li>
          <a class="nav-link active text-danger" href="Owner.php">Back</a>
      </li>
    </ul>
